...
void goodsList::print() const{
    ...
    khoHang<<"KHO HANG"<<endl;
    khoHang<<"So luong mat hang: "<<this->numOfNode()<<"\n\n";
    khoHang<<setfill('-')<<"+"<<setw(6)<<"+"<<setw(14)<<"+"<<setw(25)<<"+"<<setw(16)<<"+"<<setw(21)<<"+"<<setw(17)<<"+"<<setw(14)<<"+"<<setw(11)<<"+"<<setw(16)<<"+"<<setw(17)<<"+"<<setfill(' ')<<endl;
...
void goodsList::checkNhap(goods &S){
    cin>>S;
...
void goodsList::checkXuat(goods &S){
